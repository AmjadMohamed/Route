...
const SubCategory = () => {
    ...
    return (
        <div className="w-full md:w-[80%] mx-auto px-5 md:px-0 my-10">
            <div className="mb-8">
            ...
            {isLoading ? (
                ...
                <div className="text-center py-12">
                    ...
                    <h2 className="text-2xl font-semibold text-gray-700 mb-2">No Subcategories Found</h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    {subcategories.map((subcategory: CategoryRoot, idx: number) => (
                        <div key={idx} className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow p-6 text-center">
                            <div className="mb-4">
